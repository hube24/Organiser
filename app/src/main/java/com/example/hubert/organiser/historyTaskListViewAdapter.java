...
/**
 * Created by Hubert on 2017-02-25.
 */

public class historyTaskListViewAdapter extends ArrayAdapter<Task> {
    ...
    public historyTaskListViewAdapter(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public historyTaskListViewAdapter(Context context, int resource, List<Task> items) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.history_task_list_element, parent, false);
        }
        ...
        if (tsk != null) {
            TextView tt1 = (TextView) v.findViewById(R.id.textViewHistoryElement);
            final TextView tt2 = (TextView) v.findViewById(R.id.textViewDateOfGetDone);


            /////////// Popup z informacjami o danym zadaniu z listy ////////////
